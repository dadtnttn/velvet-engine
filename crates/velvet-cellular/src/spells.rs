...
const SPELL_TABLE: &[SpellRow] = &[
    ...
    SpellRow {
        key: "water_ball",
        name: "Water Ball",
        effect: SpellEffect::BurstMaterial,
        power: 18,
        radius: 4,
        duration: 1.0,
        material: "water",
    ...
    SpellRow {
        key: "poison_cloud",
        name: "Poison Cloud",
        effect: SpellEffect::PoisonCloud,
        power: 30,
        radius: 4,
        duration: 2.0,
        material: "poison",
    ...
    SpellRow {
        key: "paint_circle",
        name: "Paint Circle",
        effect: SpellEffect::PaintCircle,
        power: 1,
        radius: 4,
        duration: 0.0,
        material: "stone",
            ...
            for dy in -r.radius..=r.radius {
                for dx in -r.radius..=r.radius {
                    ...
                    if d2 <= r.radius * r.radius
                        && d2 > (r.radius - 1).max(0) * (r.radius - 1).max(0)
                    {
