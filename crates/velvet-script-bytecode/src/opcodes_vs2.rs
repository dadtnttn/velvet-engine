...
mod tests {
    ...
    fn op_nop() {
        ...
        assert_eq!(OpVs2::from_u16(0), Some(OpVs2::Nop));
    }
    #[test]
    fn op_loadconst() {
        assert_eq!(OpVs2::LoadConst.name(), "LoadConst");
        assert_eq!(OpVs2::from_u16(1), Some(OpVs2::LoadConst));
    }
    #[test]
    fn op_loadlocal() {
        assert_eq!(OpVs2::LoadLocal.name(), "LoadLocal");
        assert_eq!(OpVs2::from_u16(2), Some(OpVs2::LoadLocal));
    }
    #[test]
    fn op_storelocal() {
        assert_eq!(OpVs2::StoreLocal.name(), "StoreLocal");
        assert_eq!(OpVs2::from_u16(3), Some(OpVs2::StoreLocal));
    }
    #[test]
    fn op_add() {
        assert_eq!(OpVs2::Add.name(), "Add");
        assert_eq!(OpVs2::from_u16(4), Some(OpVs2::Add));
    }
    #[test]
    fn op_sub() {
        assert_eq!(OpVs2::Sub.name(), "Sub");
        assert_eq!(OpVs2::from_u16(5), Some(OpVs2::Sub));
    }
    #[test]
    fn op_mul() {
        assert_eq!(OpVs2::Mul.name(), "Mul");
        assert_eq!(OpVs2::from_u16(6), Some(OpVs2::Mul));
    }
    #[test]
    fn op_div() {
        assert_eq!(OpVs2::Div.name(), "Div");
        assert_eq!(OpVs2::from_u16(7), Some(OpVs2::Div));
    }
    #[test]
    fn op_rem() {
        assert_eq!(OpVs2::Rem.name(), "Rem");
        assert_eq!(OpVs2::from_u16(8), Some(OpVs2::Rem));
    }
    #[test]
    fn op_eq() {
        assert_eq!(OpVs2::Eq.name(), "Eq");
        assert_eq!(OpVs2::from_u16(9), Some(OpVs2::Eq));
    }
    #[test]
    fn op_ne() {
        assert_eq!(OpVs2::Ne.name(), "Ne");
        assert_eq!(OpVs2::from_u16(10), Some(OpVs2::Ne));
    }
    #[test]
    fn op_lt() {
        assert_eq!(OpVs2::Lt.name(), "Lt");
        assert_eq!(OpVs2::from_u16(11), Some(OpVs2::Lt));
    }
    #[test]
    fn op_le() {
        assert_eq!(OpVs2::Le.name(), "Le");
        assert_eq!(OpVs2::from_u16(12), Some(OpVs2::Le));
    }
    #[test]
    fn op_gt() {
        assert_eq!(OpVs2::Gt.name(), "Gt");
        assert_eq!(OpVs2::from_u16(13), Some(OpVs2::Gt));
    }
    #[test]
    fn op_ge() {
        assert_eq!(OpVs2::Ge.name(), "Ge");
        assert_eq!(OpVs2::from_u16(14), Some(OpVs2::Ge));
    }
    #[test]
    fn op_and() {
        assert_eq!(OpVs2::And.name(), "And");
        assert_eq!(OpVs2::from_u16(15), Some(OpVs2::And));
    }
    #[test]
    fn op_or() {
        assert_eq!(OpVs2::Or.name(), "Or");
        assert_eq!(OpVs2::from_u16(16), Some(OpVs2::Or));
    }
    #[test]
    fn op_not() {
        assert_eq!(OpVs2::Not.name(), "Not");
        assert_eq!(OpVs2::from_u16(17), Some(OpVs2::Not));
    }
    #[test]
    fn op_jump() {
        assert_eq!(OpVs2::Jump.name(), "Jump");
        assert_eq!(OpVs2::from_u16(18), Some(OpVs2::Jump));
    }
    #[test]
    fn op_jumpif() {
        assert_eq!(OpVs2::JumpIf.name(), "JumpIf");
        assert_eq!(OpVs2::from_u16(19), Some(OpVs2::JumpIf));
    }
    #[test]
    fn op_call() {
        assert_eq!(OpVs2::Call.name(), "Call");
        assert_eq!(OpVs2::from_u16(20), Some(OpVs2::Call));
    }
    #[test]
    fn op_ret() {
        assert_eq!(OpVs2::Ret.name(), "Ret");
        assert_eq!(OpVs2::from_u16(21), Some(OpVs2::Ret));
    }
    #[test]
    fn op_print() {
        assert_eq!(OpVs2::Print.name(), "Print");
        assert_eq!(OpVs2::from_u16(22), Some(OpVs2::Print));
    }
    #[test]
    fn op_pop() {
        assert_eq!(OpVs2::Pop.name(), "Pop");
        assert_eq!(OpVs2::from_u16(23), Some(OpVs2::Pop));
    }
    #[test]
    fn op_dup() {
        assert_eq!(OpVs2::Dup.name(), "Dup");
        assert_eq!(OpVs2::from_u16(24), Some(OpVs2::Dup));
    }
    #[test]
    fn op_say() {
        assert_eq!(OpVs2::Say.name(), "Say");
        assert_eq!(OpVs2::from_u16(25), Some(OpVs2::Say));
    }
    #[test]
    fn op_menu() {
        assert_eq!(OpVs2::Menu.name(), "Menu");
        assert_eq!(OpVs2::from_u16(26), Some(OpVs2::Menu));
    }
    #[test]
    fn op_choice() {
        assert_eq!(OpVs2::Choice.name(), "Choice");
        assert_eq!(OpVs2::from_u16(27), Some(OpVs2::Choice));
    }
    #[test]
    fn op_jumpscene() {
        assert_eq!(OpVs2::JumpScene.name(), "JumpScene");
        assert_eq!(OpVs2::from_u16(28), Some(OpVs2::JumpScene));
    }
    #[test]
    fn op_callscene() {
        assert_eq!(OpVs2::CallScene.name(), "CallScene");
        assert_eq!(OpVs2::from_u16(29), Some(OpVs2::CallScene));
    }
    #[test]
    fn op_showchar() {
        assert_eq!(OpVs2::ShowChar.name(), "ShowChar");
        assert_eq!(OpVs2::from_u16(30), Some(OpVs2::ShowChar));
    }
    #[test]
    fn op_hidechar() {
        assert_eq!(OpVs2::HideChar.name(), "HideChar");
        assert_eq!(OpVs2::from_u16(31), Some(OpVs2::HideChar));
    }
    #[test]
    fn op_background() {
        assert_eq!(OpVs2::Background.name(), "Background");
        assert_eq!(OpVs2::from_u16(32), Some(OpVs2::Background));
    }
    #[test]
    fn op_music() {
        assert_eq!(OpVs2::Music.name(), "Music");
        assert_eq!(OpVs2::from_u16(33), Some(OpVs2::Music));
    }
    #[test]
    fn op_pushlayer() {
        assert_eq!(OpVs2::PushLayer.name(), "PushLayer");
        assert_eq!(OpVs2::from_u16(34), Some(OpVs2::PushLayer));
    }
    #[test]
    fn op_poplayer() {
        assert_eq!(OpVs2::PopLayer.name(), "PopLayer");
        assert_eq!(OpVs2::from_u16(35), Some(OpVs2::PopLayer));
    }
    #[test]
    fn op_showlayer() {
        assert_eq!(OpVs2::ShowLayer.name(), "ShowLayer");
        assert_eq!(OpVs2::from_u16(36), Some(OpVs2::ShowLayer));
    }
    #[test]
    fn op_hidelayer() {
        assert_eq!(OpVs2::HideLayer.name(), "HideLayer");
        assert_eq!(OpVs2::from_u16(37), Some(OpVs2::HideLayer));
    }
    #[test]
    fn op_setlayerz() {
        assert_eq!(OpVs2::SetLayerZ.name(), "SetLayerZ");
        assert_eq!(OpVs2::from_u16(38), Some(OpVs2::SetLayerZ));
    }
    #[test]
    fn op_translate() {
        assert_eq!(OpVs2::Translate.name(), "Translate");
        assert_eq!(OpVs2::from_u16(39), Some(OpVs2::Translate));
    }
    #[test]
    fn op_await() {
        assert_eq!(OpVs2::Await.name(), "Await");
        assert_eq!(OpVs2::from_u16(40), Some(OpVs2::Await));
    }
    #[test]
    fn op_yield() {
        assert_eq!(OpVs2::Yield.name(), "Yield");
        assert_eq!(OpVs2::from_u16(41), Some(OpVs2::Yield));
    }
    #[test]
    fn op_loadmsg() {
        assert_eq!(OpVs2::LoadMsg.name(), "LoadMsg");
        assert_eq!(OpVs2::from_u16(42), Some(OpVs2::LoadMsg));
    }
    #[test]
    fn op_storestate() {
        assert_eq!(OpVs2::StoreState.name(), "StoreState");
        assert_eq!(OpVs2::from_u16(43), Some(OpVs2::StoreState));
    }
    #[test]
    fn op_loadstate() {
        assert_eq!(OpVs2::LoadState.name(), "LoadState");
        assert_eq!(OpVs2::from_u16(44), Some(OpVs2::LoadState));
    }
    #[test]
    fn op_makearray() {
        assert_eq!(OpVs2::MakeArray.name(), "MakeArray");
        assert_eq!(OpVs2::from_u16(45), Some(OpVs2::MakeArray));
    }
    #[test]
    fn op_indexget() {
        assert_eq!(OpVs2::IndexGet.name(), "IndexGet");
        assert_eq!(OpVs2::from_u16(46), Some(OpVs2::IndexGet));
    }
    #[test]
    fn op_indexset() {
        assert_eq!(OpVs2::IndexSet.name(), "IndexSet");
        assert_eq!(OpVs2::from_u16(47), Some(OpVs2::IndexSet));
    }
    #[test]
    fn op_makemap() {
        assert_eq!(OpVs2::MakeMap.name(), "MakeMap");
        assert_eq!(OpVs2::from_u16(48), Some(OpVs2::MakeMap));
    }
    #[test]
    fn op_mapget() {
        assert_eq!(OpVs2::MapGet.name(), "MapGet");
        assert_eq!(OpVs2::from_u16(49), Some(OpVs2::MapGet));
    }
    #[test]
    fn op_mapset() {
        assert_eq!(OpVs2::MapSet.name(), "MapSet");
        assert_eq!(OpVs2::from_u16(50), Some(OpVs2::MapSet));
    }
    #[test]
    fn op_ok() {
        assert_eq!(OpVs2::Ok.name(), "Ok");
        assert_eq!(OpVs2::from_u16(51), Some(OpVs2::Ok));
    }
    #[test]
    fn op_err() {
        assert_eq!(OpVs2::Err.name(), "Err");
        assert_eq!(OpVs2::from_u16(52), Some(OpVs2::Err));
    }
    #[test]
    fn op_some() {
        assert_eq!(OpVs2::Some.name(), "Some");
        assert_eq!(OpVs2::from_u16(53), Some(OpVs2::Some));
    }
    #[test]
    fn op_none_() {
        assert_eq!(OpVs2::None_.name(), "None_");
        assert_eq!(OpVs2::from_u16(54), Some(OpVs2::None_));
    }
    #[test]
    fn op_try() {
        assert_eq!(OpVs2::Try.name(), "Try");
        assert_eq!(OpVs2::from_u16(55), Some(OpVs2::Try));
    }
    #[test]
    fn op_isok() {
        assert_eq!(OpVs2::IsOk.name(), "IsOk");
        assert_eq!(OpVs2::from_u16(56), Some(OpVs2::IsOk));
    }
    #[test]
    fn op_unwrap() {
        assert_eq!(OpVs2::Unwrap.name(), "Unwrap");
        assert_eq!(OpVs2::from_u16(57), Some(OpVs2::Unwrap));
    }
    #[test]
    fn op_casti32() {
        assert_eq!(OpVs2::CastI32.name(), "CastI32");
        assert_eq!(OpVs2::from_u16(58), Some(OpVs2::CastI32));
    }
    #[test]
    fn op_castf64() {
        assert_eq!(OpVs2::CastF64.name(), "CastF64");
        assert_eq!(OpVs2::from_u16(59), Some(OpVs2::CastF64));
    }
    #[test]
    fn op_concat() {
        assert_eq!(OpVs2::Concat.name(), "Concat");
        assert_eq!(OpVs2::from_u16(60), Some(OpVs2::Concat));
    }
    #[test]
    fn op_len() {
        assert_eq!(OpVs2::Len.name(), "Len");
        assert_eq!(OpVs2::from_u16(61), Some(OpVs2::Len));
    }
    #[test]
    fn op_transformapply() {
        assert_eq!(OpVs2::TransformApply.name(), "TransformApply");
        assert_eq!(OpVs2::from_u16(62), Some(OpVs2::TransformApply));
    }
    #[test]
    fn op_transitionplay() {
        assert_eq!(OpVs2::TransitionPlay.name(), "TransitionPlay");
        assert_eq!(OpVs2::from_u16(63), Some(OpVs2::TransitionPlay));
    }
    #[test]
    fn op_actionfire() {
        assert_eq!(OpVs2::ActionFire.name(), "ActionFire");
        assert_eq!(OpVs2::from_u16(64), Some(OpVs2::ActionFire));
    }
    #[test]
    fn op_screenopen() {
        assert_eq!(OpVs2::ScreenOpen.name(), "ScreenOpen");
        assert_eq!(OpVs2::from_u16(65), Some(OpVs2::ScreenOpen));
    }
    #[test]
    fn op_screenclose() {
        assert_eq!(OpVs2::ScreenClose.name(), "ScreenClose");
        assert_eq!(OpVs2::from_u16(66), Some(OpVs2::ScreenClose));
    }
    #[test]
    fn op_bindbutton() {
        assert_eq!(OpVs2::BindButton.name(), "BindButton");
        assert_eq!(OpVs2::from_u16(67), Some(OpVs2::BindButton));
    }
    #[test]
    fn op_playsfx() {
        assert_eq!(OpVs2::PlaySfx.name(), "PlaySfx");
        assert_eq!(OpVs2::from_u16(68), Some(OpVs2::PlaySfx));
    }
    #[test]
    fn op_playvoice() {
        assert_eq!(OpVs2::PlayVoice.name(), "PlayVoice");
        assert_eq!(OpVs2::from_u16(69), Some(OpVs2::PlayVoice));
    }
    #[test]
    fn op_stopbgm() {
        assert_eq!(OpVs2::StopBgm.name(), "StopBgm");
        assert_eq!(OpVs2::from_u16(70), Some(OpVs2::StopBgm));
    }
    #[test]
    fn op_setvolume() {
        assert_eq!(OpVs2::SetVolume.name(), "SetVolume");
        assert_eq!(OpVs2::from_u16(71), Some(OpVs2::SetVolume));
    }
    #[test]
    fn op_reserved72() {
        assert_eq!(OpVs2::Reserved72.name(), "Reserved72");
        assert_eq!(OpVs2::from_u16(72), Some(OpVs2::Reserved72));
    }
    #[test]
    fn op_reserved73() {
        assert_eq!(OpVs2::Reserved73.name(), "Reserved73");
        assert_eq!(OpVs2::from_u16(73), Some(OpVs2::Reserved73));
    }
    #[test]
    fn op_reserved74() {
        assert_eq!(OpVs2::Reserved74.name(), "Reserved74");
        assert_eq!(OpVs2::from_u16(74), Some(OpVs2::Reserved74));
    }
    #[test]
    fn op_reserved75() {
        assert_eq!(OpVs2::Reserved75.name(), "Reserved75");
        assert_eq!(OpVs2::from_u16(75), Some(OpVs2::Reserved75));
    }
    #[test]
    fn op_reserved76() {
        assert_eq!(OpVs2::Reserved76.name(), "Reserved76");
        assert_eq!(OpVs2::from_u16(76), Some(OpVs2::Reserved76));
    }
    #[test]
    fn op_reserved77() {
        assert_eq!(OpVs2::Reserved77.name(), "Reserved77");
        assert_eq!(OpVs2::from_u16(77), Some(OpVs2::Reserved77));
    }
    #[test]
    fn op_reserved78() {
        assert_eq!(OpVs2::Reserved78.name(), "Reserved78");
        assert_eq!(OpVs2::from_u16(78), Some(OpVs2::Reserved78));
    }
    #[test]
    fn op_reserved79() {
        assert_eq!(OpVs2::Reserved79.name(), "Reserved79");
        assert_eq!(OpVs2::from_u16(79), Some(OpVs2::Reserved79));
    }
    #[test]
    fn op_reserved80() {
        assert_eq!(OpVs2::Reserved80.name(), "Reserved80");
        assert_eq!(OpVs2::from_u16(80), Some(OpVs2::Reserved80));
    }
    #[test]
    fn op_reserved81() {
        assert_eq!(OpVs2::Reserved81.name(), "Reserved81");
        assert_eq!(OpVs2::from_u16(81), Some(OpVs2::Reserved81));
    }
    #[test]
    fn op_reserved82() {
        assert_eq!(OpVs2::Reserved82.name(), "Reserved82");
        assert_eq!(OpVs2::from_u16(82), Some(OpVs2::Reserved82));
    }
    #[test]
    fn op_reserved83() {
        assert_eq!(OpVs2::Reserved83.name(), "Reserved83");
        assert_eq!(OpVs2::from_u16(83), Some(OpVs2::Reserved83));
    }
    #[test]
    fn op_reserved84() {
        assert_eq!(OpVs2::Reserved84.name(), "Reserved84");
        assert_eq!(OpVs2::from_u16(84), Some(OpVs2::Reserved84));
    }
    #[test]
    fn op_reserved85() {
        assert_eq!(OpVs2::Reserved85.name(), "Reserved85");
        assert_eq!(OpVs2::from_u16(85), Some(OpVs2::Reserved85));
    }
    #[test]
    fn op_reserved86() {
        assert_eq!(OpVs2::Reserved86.name(), "Reserved86");
        assert_eq!(OpVs2::from_u16(86), Some(OpVs2::Reserved86));
    }
    #[test]
    fn op_reserved87() {
        assert_eq!(OpVs2::Reserved87.name(), "Reserved87");
        assert_eq!(OpVs2::from_u16(87), Some(OpVs2::Reserved87));
    }
    #[test]
    fn op_reserved88() {
        assert_eq!(OpVs2::Reserved88.name(), "Reserved88");
        assert_eq!(OpVs2::from_u16(88), Some(OpVs2::Reserved88));
    }
    #[test]
    fn op_reserved89() {
        assert_eq!(OpVs2::Reserved89.name(), "Reserved89");
        assert_eq!(OpVs2::from_u16(89), Some(OpVs2::Reserved89));
    }
    #[test]
    fn op_reserved90() {
        assert_eq!(OpVs2::Reserved90.name(), "Reserved90");
        assert_eq!(OpVs2::from_u16(90), Some(OpVs2::Reserved90));
    }
    #[test]
    fn op_reserved91() {
        assert_eq!(OpVs2::Reserved91.name(), "Reserved91");
        assert_eq!(OpVs2::from_u16(91), Some(OpVs2::Reserved91));
    }
    #[test]
    fn op_reserved92() {
        assert_eq!(OpVs2::Reserved92.name(), "Reserved92");
        assert_eq!(OpVs2::from_u16(92), Some(OpVs2::Reserved92));
    }
    #[test]
    fn op_reserved93() {
        assert_eq!(OpVs2::Reserved93.name(), "Reserved93");
        assert_eq!(OpVs2::from_u16(93), Some(OpVs2::Reserved93));
    }
    #[test]
    fn op_reserved94() {
        assert_eq!(OpVs2::Reserved94.name(), "Reserved94");
        assert_eq!(OpVs2::from_u16(94), Some(OpVs2::Reserved94));
    }
    #[test]
    fn op_reserved95() {
        assert_eq!(OpVs2::Reserved95.name(), "Reserved95");
        assert_eq!(OpVs2::from_u16(95), Some(OpVs2::Reserved95));
    }
    #[test]
    fn op_reserved96() {
        assert_eq!(OpVs2::Reserved96.name(), "Reserved96");
        assert_eq!(OpVs2::from_u16(96), Some(OpVs2::Reserved96));
    }
    #[test]
    fn op_reserved97() {
        assert_eq!(OpVs2::Reserved97.name(), "Reserved97");
        assert_eq!(OpVs2::from_u16(97), Some(OpVs2::Reserved97));
    }
    #[test]
    fn op_reserved98() {
        assert_eq!(OpVs2::Reserved98.name(), "Reserved98");
        assert_eq!(OpVs2::from_u16(98), Some(OpVs2::Reserved98));
    }
    #[test]
    fn op_reserved99() {
        assert_eq!(OpVs2::Reserved99.name(), "Reserved99");
        assert_eq!(OpVs2::from_u16(99), Some(OpVs2::Reserved99));
    }
    #[test]
    fn op_reserved100() {
        assert_eq!(OpVs2::Reserved100.name(), "Reserved100");
        assert_eq!(OpVs2::from_u16(100), Some(OpVs2::Reserved100));
    }
    #[test]
    fn op_reserved101() {
        assert_eq!(OpVs2::Reserved101.name(), "Reserved101");
        assert_eq!(OpVs2::from_u16(101), Some(OpVs2::Reserved101));
    }
    #[test]
    fn op_reserved102() {
        assert_eq!(OpVs2::Reserved102.name(), "Reserved102");
        assert_eq!(OpVs2::from_u16(102), Some(OpVs2::Reserved102));
    }
    #[test]
    fn op_reserved103() {
        assert_eq!(OpVs2::Reserved103.name(), "Reserved103");
        assert_eq!(OpVs2::from_u16(103), Some(OpVs2::Reserved103));
    }
    #[test]
    fn op_reserved104() {
        assert_eq!(OpVs2::Reserved104.name(), "Reserved104");
        assert_eq!(OpVs2::from_u16(104), Some(OpVs2::Reserved104));
    }
    #[test]
    fn op_reserved105() {
        assert_eq!(OpVs2::Reserved105.name(), "Reserved105");
        assert_eq!(OpVs2::from_u16(105), Some(OpVs2::Reserved105));
    }
    #[test]
    fn op_reserved106() {
        assert_eq!(OpVs2::Reserved106.name(), "Reserved106");
        assert_eq!(OpVs2::from_u16(106), Some(OpVs2::Reserved106));
    }
    #[test]
    fn op_reserved107() {
        assert_eq!(OpVs2::Reserved107.name(), "Reserved107");
        assert_eq!(OpVs2::from_u16(107), Some(OpVs2::Reserved107));
    }
    #[test]
    fn op_reserved108() {
        assert_eq!(OpVs2::Reserved108.name(), "Reserved108");
        assert_eq!(OpVs2::from_u16(108), Some(OpVs2::Reserved108));
    }
    #[test]
    fn op_reserved109() {
        assert_eq!(OpVs2::Reserved109.name(), "Reserved109");
        assert_eq!(OpVs2::from_u16(109), Some(OpVs2::Reserved109));
    }
    #[test]
    fn op_reserved110() {
        assert_eq!(OpVs2::Reserved110.name(), "Reserved110");
        assert_eq!(OpVs2::from_u16(110), Some(OpVs2::Reserved110));
    }
    #[test]
    fn op_reserved111() {
        assert_eq!(OpVs2::Reserved111.name(), "Reserved111");
        assert_eq!(OpVs2::from_u16(111), Some(OpVs2::Reserved111));
    }
    #[test]
    fn op_reserved112() {
        assert_eq!(OpVs2::Reserved112.name(), "Reserved112");
        assert_eq!(OpVs2::from_u16(112), Some(OpVs2::Reserved112));
    }
    #[test]
    fn op_reserved113() {
        assert_eq!(OpVs2::Reserved113.name(), "Reserved113");
        assert_eq!(OpVs2::from_u16(113), Some(OpVs2::Reserved113));
    }
    #[test]
    fn op_reserved114() {
        assert_eq!(OpVs2::Reserved114.name(), "Reserved114");
        assert_eq!(OpVs2::from_u16(114), Some(OpVs2::Reserved114));
    }
    #[test]
    fn op_reserved115() {
        assert_eq!(OpVs2::Reserved115.name(), "Reserved115");
        assert_eq!(OpVs2::from_u16(115), Some(OpVs2::Reserved115));
    }
    #[test]
    fn op_reserved116() {
        assert_eq!(OpVs2::Reserved116.name(), "Reserved116");
        assert_eq!(OpVs2::from_u16(116), Some(OpVs2::Reserved116));
    }
    #[test]
    fn op_reserved117() {
        assert_eq!(OpVs2::Reserved117.name(), "Reserved117");
        assert_eq!(OpVs2::from_u16(117), Some(OpVs2::Reserved117));
    }
    #[test]
    fn op_reserved118() {
        assert_eq!(OpVs2::Reserved118.name(), "Reserved118");
        assert_eq!(OpVs2::from_u16(118), Some(OpVs2::Reserved118));
    }
    #[test]
    fn op_reserved119() {
        assert_eq!(OpVs2::Reserved119.name(), "Reserved119");
        assert_eq!(OpVs2::from_u16(119), Some(OpVs2::Reserved119));
    }
    #[test]
    fn op_reserved120() {
        assert_eq!(OpVs2::Reserved120.name(), "Reserved120");
        assert_eq!(OpVs2::from_u16(120), Some(OpVs2::Reserved120));
    }
    #[test]
    fn op_reserved121() {
        assert_eq!(OpVs2::Reserved121.name(), "Reserved121");
        assert_eq!(OpVs2::from_u16(121), Some(OpVs2::Reserved121));
    }
    #[test]
    fn op_reserved122() {
        assert_eq!(OpVs2::Reserved122.name(), "Reserved122");
        assert_eq!(OpVs2::from_u16(122), Some(OpVs2::Reserved122));
    }
    #[test]
    fn op_reserved123() {
        assert_eq!(OpVs2::Reserved123.name(), "Reserved123");
        assert_eq!(OpVs2::from_u16(123), Some(OpVs2::Reserved123));
    }
    #[test]
    fn op_reserved124() {
        assert_eq!(OpVs2::Reserved124.name(), "Reserved124");
        assert_eq!(OpVs2::from_u16(124), Some(OpVs2::Reserved124));
    }
    #[test]
    fn op_reserved125() {
        assert_eq!(OpVs2::Reserved125.name(), "Reserved125");
        assert_eq!(OpVs2::from_u16(125), Some(OpVs2::Reserved125));
    }
    #[test]
    fn op_reserved126() {
        assert_eq!(OpVs2::Reserved126.name(), "Reserved126");
        assert_eq!(OpVs2::from_u16(126), Some(OpVs2::Reserved126));
    }
    #[test]
    fn op_reserved127() {
        assert_eq!(OpVs2::Reserved127.name(), "Reserved127");
        assert_eq!(OpVs2::from_u16(127), Some(OpVs2::Reserved127));
    }
    #[test]
    fn op_reserved128() {
        assert_eq!(OpVs2::Reserved128.name(), "Reserved128");
        assert_eq!(OpVs2::from_u16(128), Some(OpVs2::Reserved128));
    }
    #[test]
    fn op_reserved129() {
        assert_eq!(OpVs2::Reserved129.name(), "Reserved129");
        assert_eq!(OpVs2::from_u16(129), Some(OpVs2::Reserved129));
    }
    #[test]
    fn op_reserved130() {
        assert_eq!(OpVs2::Reserved130.name(), "Reserved130");
        assert_eq!(OpVs2::from_u16(130), Some(OpVs2::Reserved130));
    }
    #[test]
    fn op_reserved131() {
        assert_eq!(OpVs2::Reserved131.name(), "Reserved131");
        assert_eq!(OpVs2::from_u16(131), Some(OpVs2::Reserved131));
    }
    #[test]
    fn op_reserved132() {
        assert_eq!(OpVs2::Reserved132.name(), "Reserved132");
        assert_eq!(OpVs2::from_u16(132), Some(OpVs2::Reserved132));
    }
    #[test]
    fn op_reserved133() {
        assert_eq!(OpVs2::Reserved133.name(), "Reserved133");
        assert_eq!(OpVs2::from_u16(133), Some(OpVs2::Reserved133));
    }
    #[test]
    fn op_reserved134() {
        assert_eq!(OpVs2::Reserved134.name(), "Reserved134");
        assert_eq!(OpVs2::from_u16(134), Some(OpVs2::Reserved134));
    }
    #[test]
    fn op_reserved135() {
        assert_eq!(OpVs2::Reserved135.name(), "Reserved135");
        assert_eq!(OpVs2::from_u16(135), Some(OpVs2::Reserved135));
    }
    #[test]
    fn op_reserved136() {
        assert_eq!(OpVs2::Reserved136.name(), "Reserved136");
        assert_eq!(OpVs2::from_u16(136), Some(OpVs2::Reserved136));
    }
    #[test]
    fn op_reserved137() {
        assert_eq!(OpVs2::Reserved137.name(), "Reserved137");
        assert_eq!(OpVs2::from_u16(137), Some(OpVs2::Reserved137));
    }
    #[test]
    fn op_reserved138() {
        assert_eq!(OpVs2::Reserved138.name(), "Reserved138");
        assert_eq!(OpVs2::from_u16(138), Some(OpVs2::Reserved138));
    }
    #[test]
    fn op_reserved139() {
        assert_eq!(OpVs2::Reserved139.name(), "Reserved139");
        assert_eq!(OpVs2::from_u16(139), Some(OpVs2::Reserved139));
    }
    #[test]
    fn op_reserved140() {
        assert_eq!(OpVs2::Reserved140.name(), "Reserved140");
        assert_eq!(OpVs2::from_u16(140), Some(OpVs2::Reserved140));
    }
    #[test]
    fn op_reserved141() {
        assert_eq!(OpVs2::Reserved141.name(), "Reserved141");
        assert_eq!(OpVs2::from_u16(141), Some(OpVs2::Reserved141));
    }
    #[test]
    fn op_reserved142() {
        assert_eq!(OpVs2::Reserved142.name(), "Reserved142");
        assert_eq!(OpVs2::from_u16(142), Some(OpVs2::Reserved142));
    }
    #[test]
    fn op_reserved143() {
        assert_eq!(OpVs2::Reserved143.name(), "Reserved143");
        assert_eq!(OpVs2::from_u16(143), Some(OpVs2::Reserved143));
    }
    #[test]
    fn op_reserved144() {
        assert_eq!(OpVs2::Reserved144.name(), "Reserved144");
        assert_eq!(OpVs2::from_u16(144), Some(OpVs2::Reserved144));
    }
    #[test]
    fn op_reserved145() {
        assert_eq!(OpVs2::Reserved145.name(), "Reserved145");
        assert_eq!(OpVs2::from_u16(145), Some(OpVs2::Reserved145));
    }
    #[test]
    fn op_reserved146() {
        assert_eq!(OpVs2::Reserved146.name(), "Reserved146");
        assert_eq!(OpVs2::from_u16(146), Some(OpVs2::Reserved146));
    }
    #[test]
    fn op_reserved147() {
        assert_eq!(OpVs2::Reserved147.name(), "Reserved147");
        assert_eq!(OpVs2::from_u16(147), Some(OpVs2::Reserved147));
    }
    #[test]
    fn op_reserved148() {
        assert_eq!(OpVs2::Reserved148.name(), "Reserved148");
        assert_eq!(OpVs2::from_u16(148), Some(OpVs2::Reserved148));
    }
    #[test]
    fn op_reserved149() {
        assert_eq!(OpVs2::Reserved149.name(), "Reserved149");
        assert_eq!(OpVs2::from_u16(149), Some(OpVs2::Reserved149));
    }
    #[test]
    fn op_reserved150() {
        assert_eq!(OpVs2::Reserved150.name(), "Reserved150");
        assert_eq!(OpVs2::from_u16(150), Some(OpVs2::Reserved150));
    }
    #[test]
    fn op_reserved151() {
        assert_eq!(OpVs2::Reserved151.name(), "Reserved151");
        assert_eq!(OpVs2::from_u16(151), Some(OpVs2::Reserved151));
    }
    #[test]
    fn op_reserved152() {
        assert_eq!(OpVs2::Reserved152.name(), "Reserved152");
        assert_eq!(OpVs2::from_u16(152), Some(OpVs2::Reserved152));
    }
    #[test]
    fn op_reserved153() {
        assert_eq!(OpVs2::Reserved153.name(), "Reserved153");
        assert_eq!(OpVs2::from_u16(153), Some(OpVs2::Reserved153));
    }
    #[test]
    fn op_reserved154() {
        assert_eq!(OpVs2::Reserved154.name(), "Reserved154");
        assert_eq!(OpVs2::from_u16(154), Some(OpVs2::Reserved154));
    }
    #[test]
    fn op_reserved155() {
        assert_eq!(OpVs2::Reserved155.name(), "Reserved155");
        assert_eq!(OpVs2::from_u16(155), Some(OpVs2::Reserved155));
    }
    #[test]
    fn op_reserved156() {
        assert_eq!(OpVs2::Reserved156.name(), "Reserved156");
        assert_eq!(OpVs2::from_u16(156), Some(OpVs2::Reserved156));
    }
    #[test]
    fn op_reserved157() {
        assert_eq!(OpVs2::Reserved157.name(), "Reserved157");
        assert_eq!(OpVs2::from_u16(157), Some(OpVs2::Reserved157));
    }
    #[test]
    fn op_reserved158() {
        assert_eq!(OpVs2::Reserved158.name(), "Reserved158");
        assert_eq!(OpVs2::from_u16(158), Some(OpVs2::Reserved158));
    }
    #[test]
    fn op_reserved159() {
        assert_eq!(OpVs2::Reserved159.name(), "Reserved159");
        assert_eq!(OpVs2::from_u16(159), Some(OpVs2::Reserved159));
    }
    #[test]
    fn op_reserved160() {
        assert_eq!(OpVs2::Reserved160.name(), "Reserved160");
        assert_eq!(OpVs2::from_u16(160), Some(OpVs2::Reserved160));
    }
    #[test]
    fn op_reserved161() {
        assert_eq!(OpVs2::Reserved161.name(), "Reserved161");
        assert_eq!(OpVs2::from_u16(161), Some(OpVs2::Reserved161));
    }
    #[test]
    fn op_reserved162() {
        assert_eq!(OpVs2::Reserved162.name(), "Reserved162");
        assert_eq!(OpVs2::from_u16(162), Some(OpVs2::Reserved162));
    }
    #[test]
    fn op_reserved163() {
        assert_eq!(OpVs2::Reserved163.name(), "Reserved163");
        assert_eq!(OpVs2::from_u16(163), Some(OpVs2::Reserved163));
    }
    #[test]
    fn op_reserved164() {
        assert_eq!(OpVs2::Reserved164.name(), "Reserved164");
        assert_eq!(OpVs2::from_u16(164), Some(OpVs2::Reserved164));
    }
    #[test]
    fn op_reserved165() {
        assert_eq!(OpVs2::Reserved165.name(), "Reserved165");
        assert_eq!(OpVs2::from_u16(165), Some(OpVs2::Reserved165));
    }
    #[test]
    fn op_reserved166() {
        assert_eq!(OpVs2::Reserved166.name(), "Reserved166");
        assert_eq!(OpVs2::from_u16(166), Some(OpVs2::Reserved166));
    }
    #[test]
    fn op_reserved167() {
        assert_eq!(OpVs2::Reserved167.name(), "Reserved167");
        assert_eq!(OpVs2::from_u16(167), Some(OpVs2::Reserved167));
    }
    #[test]
    fn op_reserved168() {
        assert_eq!(OpVs2::Reserved168.name(), "Reserved168");
        assert_eq!(OpVs2::from_u16(168), Some(OpVs2::Reserved168));
    }
    #[test]
    fn op_reserved169() {
        assert_eq!(OpVs2::Reserved169.name(), "Reserved169");
        assert_eq!(OpVs2::from_u16(169), Some(OpVs2::Reserved169));
    }
    #[test]
    fn op_reserved170() {
        assert_eq!(OpVs2::Reserved170.name(), "Reserved170");
        assert_eq!(OpVs2::from_u16(170), Some(OpVs2::Reserved170));
    }
    #[test]
    fn op_reserved171() {
        assert_eq!(OpVs2::Reserved171.name(), "Reserved171");
        assert_eq!(OpVs2::from_u16(171), Some(OpVs2::Reserved171));
    }
    #[test]
    fn op_reserved172() {
        assert_eq!(OpVs2::Reserved172.name(), "Reserved172");
        assert_eq!(OpVs2::from_u16(172), Some(OpVs2::Reserved172));
    }
    #[test]
    fn op_reserved173() {
        assert_eq!(OpVs2::Reserved173.name(), "Reserved173");
        assert_eq!(OpVs2::from_u16(173), Some(OpVs2::Reserved173));
    }
    #[test]
    fn op_reserved174() {
        assert_eq!(OpVs2::Reserved174.name(), "Reserved174");
        assert_eq!(OpVs2::from_u16(174), Some(OpVs2::Reserved174));
    }
    #[test]
    fn op_reserved175() {
        assert_eq!(OpVs2::Reserved175.name(), "Reserved175");
        assert_eq!(OpVs2::from_u16(175), Some(OpVs2::Reserved175));
    }
    #[test]
    fn op_reserved176() {
        assert_eq!(OpVs2::Reserved176.name(), "Reserved176");
        assert_eq!(OpVs2::from_u16(176), Some(OpVs2::Reserved176));
    }
    #[test]
    fn op_reserved177() {
        assert_eq!(OpVs2::Reserved177.name(), "Reserved177");
        assert_eq!(OpVs2::from_u16(177), Some(OpVs2::Reserved177));
    }
    #[test]
    fn op_reserved178() {
        assert_eq!(OpVs2::Reserved178.name(), "Reserved178");
        assert_eq!(OpVs2::from_u16(178), Some(OpVs2::Reserved178));
    }
    #[test]
    fn op_reserved179() {
        assert_eq!(OpVs2::Reserved179.name(), "Reserved179");
        assert_eq!(OpVs2::from_u16(179), Some(OpVs2::Reserved179));
    }
    #[test]
    fn op_reserved180() {
        assert_eq!(OpVs2::Reserved180.name(), "Reserved180");
        assert_eq!(OpVs2::from_u16(180), Some(OpVs2::Reserved180));
    }
    #[test]
    fn op_reserved181() {
        assert_eq!(OpVs2::Reserved181.name(), "Reserved181");
        assert_eq!(OpVs2::from_u16(181), Some(OpVs2::Reserved181));
    }
    #[test]
    fn op_reserved182() {
        assert_eq!(OpVs2::Reserved182.name(), "Reserved182");
        assert_eq!(OpVs2::from_u16(182), Some(OpVs2::Reserved182));
    }
    #[test]
    fn op_reserved183() {
        assert_eq!(OpVs2::Reserved183.name(), "Reserved183");
        assert_eq!(OpVs2::from_u16(183), Some(OpVs2::Reserved183));
    }
    #[test]
    fn op_reserved184() {
        assert_eq!(OpVs2::Reserved184.name(), "Reserved184");
        assert_eq!(OpVs2::from_u16(184), Some(OpVs2::Reserved184));
    }
    #[test]
    fn op_reserved185() {
        assert_eq!(OpVs2::Reserved185.name(), "Reserved185");
        assert_eq!(OpVs2::from_u16(185), Some(OpVs2::Reserved185));
    }
    #[test]
    fn op_reserved186() {
        assert_eq!(OpVs2::Reserved186.name(), "Reserved186");
        assert_eq!(OpVs2::from_u16(186), Some(OpVs2::Reserved186));
    }
    #[test]
    fn op_reserved187() {
        assert_eq!(OpVs2::Reserved187.name(), "Reserved187");
        assert_eq!(OpVs2::from_u16(187), Some(OpVs2::Reserved187));
    }
    #[test]
    fn op_reserved188() {
        assert_eq!(OpVs2::Reserved188.name(), "Reserved188");
        assert_eq!(OpVs2::from_u16(188), Some(OpVs2::Reserved188));
    }
    #[test]
    fn op_reserved189() {
        assert_eq!(OpVs2::Reserved189.name(), "Reserved189");
        assert_eq!(OpVs2::from_u16(189), Some(OpVs2::Reserved189));
    }
    #[test]
    fn op_reserved190() {
        assert_eq!(OpVs2::Reserved190.name(), "Reserved190");
        assert_eq!(OpVs2::from_u16(190), Some(OpVs2::Reserved190));
    }
    #[test]
    fn op_reserved191() {
        assert_eq!(OpVs2::Reserved191.name(), "Reserved191");
        assert_eq!(OpVs2::from_u16(191), Some(OpVs2::Reserved191));
    }
    #[test]
    fn op_reserved192() {
        assert_eq!(OpVs2::Reserved192.name(), "Reserved192");
        assert_eq!(OpVs2::from_u16(192), Some(OpVs2::Reserved192));
    }
    #[test]
    fn op_reserved193() {
        assert_eq!(OpVs2::Reserved193.name(), "Reserved193");
        assert_eq!(OpVs2::from_u16(193), Some(OpVs2::Reserved193));
    }
    #[test]
    fn op_reserved194() {
        assert_eq!(OpVs2::Reserved194.name(), "Reserved194");
        assert_eq!(OpVs2::from_u16(194), Some(OpVs2::Reserved194));
    }
    #[test]
    fn op_reserved195() {
        assert_eq!(OpVs2::Reserved195.name(), "Reserved195");
        assert_eq!(OpVs2::from_u16(195), Some(OpVs2::Reserved195));
    }
    #[test]
    fn op_reserved196() {
        assert_eq!(OpVs2::Reserved196.name(), "Reserved196");
        assert_eq!(OpVs2::from_u16(196), Some(OpVs2::Reserved196));
    }
    #[test]
    fn op_reserved197() {
        assert_eq!(OpVs2::Reserved197.name(), "Reserved197");
        assert_eq!(OpVs2::from_u16(197), Some(OpVs2::Reserved197));
    }
    #[test]
    fn op_reserved198() {
        assert_eq!(OpVs2::Reserved198.name(), "Reserved198");
        assert_eq!(OpVs2::from_u16(198), Some(OpVs2::Reserved198));
    }
    #[test]
    fn op_reserved199() {
        assert_eq!(OpVs2::Reserved199.name(), "Reserved199");
        assert_eq!(OpVs2::from_u16(199), Some(OpVs2::Reserved199));
    }
    #[test]
    fn all_400() {
        for i in 0..400u16 {
